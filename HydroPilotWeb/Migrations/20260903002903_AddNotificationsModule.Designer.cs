...
namespace HydroPilotWeb.Migrations
{
    ...
    [Migration("20260903002903_AddNotificationsModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HydroPilotWeb.Models.Notifications.NotificationAlert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Fingerprint")
                        .IsUnique()
                        .HasFilter("[Fingerprint] <> ''");

                    b.HasIndex("LotId");

                    b.HasIndex("CreatedAtUtc", "Type", "Severity");

                    b.ToTable("NotificationAlerts", (string)null);
                });

            modelBuilder.Entity("HydroPilotWeb.Models.Notifications.NotificationAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HydroPilotWeb.Models.Notifications.NotificationDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HydroPilotWeb.Models.Notifications.NotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("HarvestAlertDays")
                        .HasColumnType("int");

                    b.Property<string>("MinSeverityEmail")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");
            ...
            modelBuilder.Entity("HydroPilotWeb.Models.Notifications.NotificationAttempt", b =>
                {
                    b.HasOne("HydroPilotWeb.Models.Notifications.NotificationDelivery", "Delivery")
            ...
            modelBuilder.Entity("HydroPilotWeb.Models.Notifications.NotificationDelivery", b =>
                {
                    b.HasOne("HydroPilotWeb.Models.Notifications.NotificationAlert", "Alert")
                        .WithMany("Deliveries")
